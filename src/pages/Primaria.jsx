...
const Primaria = () => {
  ...
  const buttonStyle = {
    width: '280px',
    height: '80px',
    backgroundColor: 'rgba(135, 206, 235, 0.5)', // Celeste capri claro transparente
    borderRadius: '15px',
    border: 'none',
    margin: '10px',
    fontWeight: 'bold',
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ 
        ...
        <button onClick={() => navigate('/PrimariaDatosAlumnos')} style={buttonStyle}>
          CARGAR DATOS DE ALUMNOS
        </button>
        <button onClick={() => navigate('/PrimariaCalificacionesAlumnos')} style={buttonStyle}>
          CARGAR CALIFICACIONES DE ALUMNOS
        </button>
        <button onClick={() => navigate('/PrimariaLibroMatriz')} style={buttonStyle}>
          LIBRO MATRIZ
        </button>
        <button onClick={() => navigate('/PrimariaLibroPlanillas')} style={buttonStyle}>
          LIBRO DE PLANILLAS
        </button>
        <button onClick={() => navigate('/PrimariaLibroActas')} style={buttonStyle}>
          LIBRO DE ACTAS
        </button>
        <button onClick={() => navigate('/PrimariaCompendios')} style={buttonStyle}>
          COMPENDIOS EN BLANCO
        </button>
        <button onClick={() => navigate('/PrimariaPlanificacion')} style={buttonStyle}>
          ENTREGA DE PLANIFICACION
        </button>
        <button onClick={() => navigate('/PrimariaProgramaAnual')} style={buttonStyle}>
          ENTREGA DE PROGRAMA ANUAL
        </button>
        <button onClick={() => navigate('/PrimariaProgramaReal')} style={buttonStyle}>
          ENTREGA DE PROGRAMA REAL
        </button>
        <button onClick={() => navigate('/PrimariaLegajoAlumno')} style={buttonStyle}>
          LEGAJO DE ALUMNO
        </button>
        <button onClick={() => navigate('/PrimariaRegistroExamen')} style={buttonStyle}>
